  ...
  return (
    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4,1fr)', gap: 10, marginBottom: 4 }}>
      {[
        ...
        { label: 'Public Affairs', value: pa, sub: '', valueColor: '#fff', dark: true, bg: 'var(--ink)' },
        { label: 'Velfærd', value: vel, sub: '', valueColor: '#fff', dark: true, bg: 'var(--vel)' },
        { label: 'Rebizz-matches', value: rebizz, sub: '', valueColor: 'var(--gold)', dark: false, bg: 'var(--surface)' },
      ].map(c => (
